...
export default function TaskForm({ onSubmit, onCancel, loading = false }) {
  ...
  return (
    <div className="p-4 bg-(--bg-secondary)">
      <div className="mb-3">
        <label
          className="flex items-center gap-1.5 mb-1.5 text-xs font-semibold text-(--text-secondary)
        ...
        <div className="relative">
          <input
            ...
            className={`w-full pl-4 pr-3 py-2 min-h-9 text-sm rounded-lg border outline-none
              bg-(--bg-primary) text-(--text-primary) placeholder:font-light placeholder:text-(--text-muted) transition-colors
              ${
                errors.title
