export default function TaskOverview({ completed = 0, incomplete = 0, total = 0 }) {
  ...
  return (
    <div
      className="bg-(--bg-secondary) border border-(--border-color) rounded-lg p-5 flex flex-col gap-5"
      style={{ boxShadow: "var(--shadow-pink)" }}
    >
      {/* Header */}
      <div className="flex items-start justify-between">
        <div className="flex flex-col gap-1">
          <p className="text-xs font-semibold py-2 text-(--text-primary) opacity-50 uppercase tracking-widest font-interface">
            Tasks Overview
          </p>
